...
app.config['MYSQL_DATABASE_HOST'] = 'abraham-rds.cpg0iuo2e341.us-east-1.rds.amazonaws.com' # Add you RDS endpoint here.
app.config['MYSQL_DATABASE_USER'] = 'admin'
app.config['MYSQL_DATABASE_PASSWORD'] = 'clarusway-devops'
